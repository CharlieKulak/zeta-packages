return {
  ...
  { name = "abseil-cpp", version = "20260526.0", summary = "Abseil C++ common libraries (strings, hash, time, logging)" },
  ...
  { name = "bandwhich", version = "0.23.1", summary = "Terminal bandwidth utilization tool" },
  { name = "bat", version = "0.26.1", summary = "cat(1) clone with syntax highlighting and git integration" },
  ...
  { name = "cbonsai", version = "master", summary = "C Bonsai terminal screensaver" },
  { name = "chafa", version = "1.18.2", summary = "Terminal graphics: images as ANSI/Unicode" },
  { name = "cheat", version = "5.1.0", summary = "Interactive cheatsheets on the command line" },
  ...
  { name = "delta", version = "0.19.2", summary = "Syntax-highlighting pager for git and diff output" },
  { name = "difftastic", version = "0.70.0", summary = "Structural diff tool that compares files by syntax" },
  { name = "discord", version = "1.0.152", summary = "Discord (stable Electron client)" },
  { name = "dkms", version = "3.4.2", summary = "Dynamic Kernel Module Support framework (rebuild out-of-tree modules on kernel updates)" },
  { name = "doas", version = "6.8.2", summary = "Execute commands as another user (portable OpenBSD doas)" },
  { name = "doggo", version = "1.3.0", summary = "Modern DNS client with colorful output" },
  { name = "double-conversion", version = "3.4.0", summary = "IEEE-754 binary/decimal conversion library" },
  { name = "duf", version = "0.9.1", summary = "Disk usage/free utility with a friendly UI" },
  { name = "dust", version = "1.2.4", summary = "More intuitive du — disk usage analyzer" },
  { name = "ede", version = "2.1", summary = "Equinox Desktop Environment, small and fast FLTK-based desktop (panel, desktop icons, apps)" },
  { name = "edelib", version = "2.1", summary = "EDE base C++ library on FLTK (shared foundation of the Equinox Desktop Environment)" },
  ...
  { name = "eza", version = "0.23.5", summary = "Modern replacement for ls" },
  ...
  { name = "feh", version = "3.12.2", summary = "Fast and lightweight image viewer" },
  ...
  { name = "figlet", version = "2.2.5", summary = "Program for making large letters out of ordinary text" },
  ...
  { name = "fltk", version = "1.3.11", summary = "Fast Light Toolkit, C++ GUI library (widget toolkit used by the Equinox Desktop Environment)" },
  ...
  { name = "fzf", version = "0.74.2", summary = "Command-line fuzzy finder" },
  { name = "garcon", version = "4.20.0", summary = "Freedesktop.org menu library for Xfce" },
  { name = "gcc", version = "16.2.0", summary = "GNU Compiler Collection (C and C++ frontends) — required to build out-of-tree kernel modules like nvidia" },
  { name = "gdk-pixbuf", version = "2.42.12", summary = "Image loading and scaling library" },
  { name = "gdu", version = "5.36.1", summary = "Fast disk usage analyzer with console UI" },
  { name = "gh", version = "2.97.0", summary = "GitHub's official command-line tool" },
  { name = "git", version = "2.50.0", summary = "Distributed version control system" },
  { name = "gitui", version = "0.28.1", summary = "Blazing-fast terminal UI for git" },
  ...
  { name = "glow", version = "3.0.0", summary = "Render markdown in the terminal" },
  { name = "glslang", version = "16.5.0", summary = "OpenGL and OpenGL ES shader front end and validator (GLSL -> SPIR-V)" },
  { name = "glycin", version = "2.1.5", summary = "Sandboxed image decoding library (libglycin) and gdk-pixbuf loaders" },
  ...
  { name = "gping", version = "v1.20.4", summary = "Ping, but with a graph" },
  ...
  { name = "gum", version = "0.17.0", summary = "Tool for writing glamorous shell scripts" },
  { name = "gzip", version = "1.13", summary = "GNU gzip compression utilities" },
  { name = "harfbuzz", version = "11.1.0", summary = "Text shaping library" },
  { name = "helium", version = "0.15.5.1", summary = "Privacy-focused Chromium-based web browser" },
  { name = "helix", version = "25.07.1", summary = "Post-modern modal text editor written in Rust" },
  ...
  { name = "hyperfine", version = "1.20.0", summary = "Command-line benchmarking tool" },
  { name = "hyprcursor", version = "0.1.13", summary = "Hyprland cursor theme format library and hyprcursor-util" },
  { name = "hyprgraphics", version = "0.5.1", summary = "Hyprland graphics libraries" },
  { name = "hypridle", version = "0.1.8", summary = "Idle management daemon for Hyprland" },
  { name = "hyprland", version = "0.56.2", summary = "Dynamic tiling Wayland compositor" },
  { name = "hyprland-protocols", version = "0.7.0", summary = "Wayland protocol headers and XMLs for Hyprland" },
  { name = "hyprland-qt-support", version = "0.1.0", summary = "Helper library for Hyprland Qt apps" },
  { name = "hyprland-qtutils", version = "0.1.5", summary = "Qt6/QML utilities for the Hyprland ecosystem" },
  { name = "hyprlang", version = "0.6.8", summary = "Hyprland config language parser library" },
  { name = "hyprlock", version = "0.9.6", summary = "Hyprland's GPU-accelerated lock screen" },
  { name = "hyprpaper", version = "0.8.4", summary = "Hyprland wallpaper utility" },
  { name = "hyprpicker", version = "0.4.7", summary = "Screen color picker for Hyprland" },
  { name = "hyprpolkitagent", version = "0.1.3", summary = "Polkit authentication agent for Hyprland (Qt6)" },
  { name = "hyprsunset", version = "0.4.0", summary = "Blue light filter for Hyprland (gamma control)" },
  ...
  { name = "jam", version = "2.5", summary = "Jam, Perforce make(1) replacement (build tool used by the Equinox Desktop Environment)" },
  { name = "joe", version = "4.6", summary = "Joe's Own Editor — a friendly UNIX text editor" },
  { name = "jq", version = "1.8.2", summary = "Lightweight and flexible command-line JSON processor" },
  { name = "json-c", version = "0.18.0", summary = "JSON library" },
  { name = "jsoncpp", version = "1.9.6", summary = "C++ JSON reader/writer" },
  { name = "jujutsu", version = "0.44.0", summary = "Git-compatible version control system" },
  { name = "just", version = "1.58.0", summary = "Handy way to save and run project-specific commands" },
  ...
  { name = "lazygit", version = "0.64.1", summary = "Simple terminal UI for git commands" },
  ...
  { name = "lf", version = "r42", summary = "Terminal file manager written in Go" },
  ...
  { name = "libei", version = "1.6.0", summary = "Library for Emulated Input (libei) and Emulated Input Server (libeis)" },
  ...
  { name = "linux-headers-6.16", version = "6.16.0", summary = "Kernel headers and build tree for Linux 6.16 (Zerene base install) — required to build out-of-tree modules" },
  { name = "linux-headers-7.1.8", version = "7.1.8", summary = "Kernel headers and build tree for Linux 7.1.8 (post-genkernel kernel) — required to build out-of-tree modules" },
  { name = "linux-pam", version = "1.7.2", summary = "Pluggable Authentication Modules library and modules" },
  { name = "lm-sensors", version = "3.6.2", summary = "Hardware sensors monitoring library (libsensors)" },
  { name = "lsd", version = "1.2.0", summary = "ls deluxe: pretty ls with icons and colors" },
  { name = "lua", version = "5.5.1", summary = "Powerful lightweight scripting language (Lua 5.5)" },
  ...
  { name = "macchina", version = "6.4.0", summary = "Fast, minimal system information fetcher" },
  ...
  { name = "mcfly", version = "0.9.4", summary = "Fly through your shell history" },
  ...
  { name = "nano", version = "8.4", summary = "Small, friendly text editor inspired by Pico" },
  { name = "ncdu", version = "1.22", summary = "NCurses disk usage viewer" },
  ...
  { name = "niri", version = "26.04", summary = "Scrollable-tiling Wayland compositor" },
  ...
  { name = "nushell", version = "0.115.0", summary = "Modern shell with structured data" },
  { name = "nvidia", version = "595.71.05", summary = "NVIDIA official driver (meta-package: DKMS kernel modules + userspace, auto-blacklists nouveau)" },
  ...
  { name = "nvidia-dkms", version = "595.71.05", summary = "NVIDIA official open GPU kernel modules via DKMS (rebuilt automatically on kernel updates)" },
  ...
  { name = "nvidia-utils", version = "595.71.05", summary = "NVIDIA official driver userspace (vendor GL/EGL/GLES/Vulkan libs, tools, Xorg modules, boot-time module loading)" },
  { name = "onefetch", version = "2.27.1", summary = "Git repository summary on the command line" },
  ...
  { name = "procs", version = "0.14.12", summary = "Modern replacement for ps written in Rust" },
  ...
  { name = "rclone", version = "1.75.0", summary = "Rsync for cloud storage" },
  { name = "re2", version = "2025-11-05", summary = "Fast, safe, thread-friendly regular expression library (RE2)" },
  { name = "restic", version = "0.19.1", summary = "Fast, secure, efficient backup program" },
  ...
  { name = "screen", version = "5.0.0", summary = "Full-screen window manager that multiplexes a physical terminal" },
  { name = "sd", version = "1.1.0", summary = "Intuitive find-and-replace CLI (sed alternative)" },
  { name = "sdbus-cpp", version = "2.3.1", summary = "High-level C++ D-Bus library for Linux (sd-bus)" },
  ...
  { name = "sl", version = "5.02", summary = "Steam locomotive that runs across your terminal" },
  ...
  { name = "spirv-headers", version = "1.4.357.0", summary = "SPIR-V header files (Khronos SPIR-V machine-readable interface definitions)" },
  { name = "spirv-tools", version = "2026.3", summary = "Khronos SPIR-V tools and libraries (assemble, validate, optimize)" },
  { name = "sqlite", version = "3.53.4", summary = "Self-contained, embeddable SQL database engine" },
  { name = "st", version = "0.9.2", summary = "Simple terminal implementation for X" },
  { name = "starship", version = "1.26.0", summary = "The minimal, blazing-fast, infinitely customizable prompt" },
  ...
  { name = "syncthing", version = "2.1.3", summary = "Continuous file synchronization" },
  ...
  { name = "tealdeer", version = "1.8.1", summary = "Very fast implementation of tldr pages" },
  { name = "termshark", version = "2.4.0", summary = "Terminal UI for tshark, a Wireshark protocol analyzer" },
  ...
  { name = "tmux", version = "3.5a", summary = "Terminal multiplexer" },
  { name = "tokei", version = "12.1.2", summary = "Fast code statistics tool" },
  { name = "tomlplusplus", version = "3.4.0", summary = "Header-friendly TOML config file parser for C++17 (shared lib)" },
  ...
  { name = "watchexec", version = "2.5.1", summary = "Execute commands when files change" },
  ...
  { name = "xcb-util-errors", version = "1.0.1", summary = "XCB utility library for printing error codes" },
  ...
  { name = "xdg-desktop-portal-hyprland", version = "1.4.1", summary = "XDG Desktop Portal backend for Hyprland (and wlroots)" },
  ...
  { name = "xh", version = "0.26.2", summary = "Friendly and fast tool for sending HTTP requests" },
  ...
  { name = "xwayland-satellite", version = "0.8.2", summary = "Rootless Xwayland integration for any Wayland compositor (xdg_wm_base + viewporter)" },
  { name = "xz-utils", version = "5.6.4", summary = "XZ/LZMA compression (xz, lzma, liblzma)" },
  { name = "yazi", version = "26.8.15", summary = "Blazing-fast terminal file manager with image preview" },
  { name = "yt-dlp", version = "2026.07.04", summary = "Downloader for YouTube and many other sites" },
  { name = "zellij", version = "0.44.3", summary = "Terminal workspace and multiplexer" },
  { name = "zip", version = "3.0", summary = "InfoZIP archiver" },
  { name = "zoxide", version = "0.10.0", summary = "Smarter cd command that tracks your most used directories" },
